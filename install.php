...
$dotsql="cheverito.sqlite.sql";
echo "Instalador de Cheverito.\n";
...
if($o==1){
	...
	ORM::configure('sqlite:./db/cheverito.db');
	$db = ORM::get_db();
	...
	echo "Nick [Cheverito^^]: "; $ircnick=trim(fgets(STDIN)); if(!$ircnick){$ircnick="Cheverito^^";}
