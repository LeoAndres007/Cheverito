...
class CoBot{
	...
	public function __construct($config){
		...
		$this->irc->setCtcpVersion("Cheverito/".VER);
		...
		ini_set("user_agent", "Cheverito/".VER);
	}
	...
	public function help(&$irc, $data){
		...
		if((!isset($data->messageex[1])) || ($data->messageex[1]== "")){
			$irc->message(SMARTIRC_TYPE_CHANNEL, $data->channel, "Cheverito v".VER."Comandos empezar con ".$this->conf['irc']['prefix'].". Escriba ".$this->conf['irc']['prefix']."help <comando> para mas información acerca de un comando.");
			$commands="";
	...
	public function connect(){
		...
		$this->irc->login($this->conf['irc']['nick'], 'Cheverito/'.VER.'', 0, $this->conf['irc']['nick']);
